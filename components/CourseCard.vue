        ...
        <div class="course-card">
            ...
            <div>
                ...
                <div class="meta tutor_meta_space">
                    <p class="d-flex meta_text align-center">{{ rating }}<img class="imgSize py-0" src="/images/crse_star.png" /></p>
                    <p class="d-flex meta_text tutorHatSize align-center"><img src="/images/tutor_hat.png" />410 Enroll</p>
                </div>
                <div class="pricingSec px-3 d-flex justify-content-between">
                    <p class="mb-0">₹ {{ selectedVariant.salePrice > 0 ? selectedVariant.salePrice : selectedVariant.price }} /- 
                      <span v-if="selectedVariant.salePrice" class="old_price">₹ {{ selectedVariant.price }} /-</span>
                    </p>
            ...
            <v-card class="course-card course_info">
                <div class="overviewData">
                    ...
                    <div class="duration_price_div">
                        <div v-for="(variant, index) in productVariants" :key="index" class="d-flex align-center duration_mt justify-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button @click="addToCart" :disabled="!courseDuration || cartStore.cartAdd" :class="{ 'disabled-button': !courseDuration }" class="course_info_btn">
